...
Локальный музыкальный плеер. Нативный UI на [iced](https://iced.rs/), без браузера внутри. Версия **0.1.2-beta2** (Free): скачал, указал папку, слушаешь. Поиск и плейлисты в интерфейсе ещё не выведены. macOS нет.
