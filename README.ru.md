...
Локальный музыкальный плеер. Нативный UI на [iced](https://iced.rs/), без браузера внутри. Версия **0.1.1-beta** (Free): скачал, указал папку, слушаешь. Поиск и плейлисты в интерфейсе ещё не выведены. macOS нет.
...
| Нативный формат PCM | да | нет (позже) |
